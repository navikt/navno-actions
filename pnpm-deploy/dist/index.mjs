...
//#endregion
//#region pnpm-deploy/src/main.ts
async function run() {
	try {
		for (const line of getMultilineInput("packages", { required: true })) {
			const words = line.split(/\s+/);
			if (words.length !== 2) throw new Error(`expected "<package> <output-dir>", got: ${line}`);
